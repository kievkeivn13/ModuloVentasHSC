...
namespace CapaModelo
{
    ...
    public class SentenciasEnlaceContable
    {
        ...
        public string calculoDebe(string fechaI, string fechaF)
        {
            ...
            string total = "";
            string Query = "select sum(saldo) from polizaDetalle where concepto like '%Venta%' and idTipoOperacion = '1' and" +
        ...
        public string calculoHaber(string fechaI, string fechaF)
        {
            ...
            string total = "";
            string Query = "select sum(saldo) from polizaDetalle where concepto like '%Venta%' and idTipoOperacion = '2' and" +
                " fechaPoliza between cast('" + fechaI + "' as date) and cast('" + fechaF + "' as date) ;";
